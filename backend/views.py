...
def course_query(request):
    if(request.method == "POST"):
        ...
        # print ('query: ' + query)
        cs_url = 'http://211.159.175.12:8080/solr/mynode/select?'#q=Bill&wt=json&indent=true'
...
#          the list is ordered by id temporaily (can be modified to revelance)
@csrf_exempt
def resource_query(request): #http://211.159.175.12:8080/solr/mynode2/select?q=%E6%95%B0%E6%8D%AE%E5%BA%93&fq=course_code%3AB3I08224C&rows=1000&wt=json&indent=true
#    print("UUUUUUUUU")
...
#    course_id = request.GET['course_id']
    ...
    if(request.method == "POST"):
        ...
        cs_url = 'http://211.159.175.12:8080/solr/mynode2/select?'
